...
import { createAnimationState as createAnimationState$1, parseTimelineOffset, createAnimationObservable as createAnimationObservable$1 } from '../utils';
...
class Timeline {
    ...
    constructor(options = {}) {
        var _a;
        this.animations = [];
        this.animationState = createAnimationState$1();
    ...
    play() {
        ...
        this.timelineSubscription = createAnimationObservable$1(this._duration, this.startTime).pipe(tap(progress => {
            this.animationState.progress$.next(progress);
...
export { Animation, Timeline, interpolate, updateTargetProperties };
